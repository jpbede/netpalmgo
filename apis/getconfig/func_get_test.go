...
func TestClient_Get(t *testing.T) {
	...
	connArgs := models.ConnectionArgs{
		DeviceType: "vyos",
		Host:       "10.10.10.10",
		Username:   "demo",
		Password:   "demo",
